...
const ADMIN_TOOLS = {
  'Data & Catalog': [
    ...
    { name: 'Repair Subcategories', route: 'AdminDataMaintenance', icon: RefreshCw, description: 'Fix missing plant_subcategory_id for any plant type — scroll down to "Repair Subcategories & Varieties" section' },
